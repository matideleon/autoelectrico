...
/* ============================================================
   ...
   Se monta una sola vez en layout.tsx, así aparece en todo el
   sitio sin tener que agregarlo página por página.

   El link de WhatsApp usa el formato internacional wa.me:
   598 (Uruguay) + el número sin el 0 inicial.
   ============================================================ */
...
const WHATSAPP_NUMBER = '59895904714'; // 598 + 95904714 (sin el 0 inicial)
...
export default function AdCTA() {
  return (
    <div style={S.wrap}>
      <div style={S.inner}>
        <p style={S.text}>
          <strong>¿Querés anunciarte en autoelectrico.uy?</strong> Esta
          herramienta fue creada para aportar información útil a la
          comunidad EV de Uruguay. La publicidad nos ayuda a cubrir los
          costos operativos del sitio, mantener los datos actualizados y
          seguir sumando mejoras.
        </p>
        <a
          href={WHATSAPP_URL}
          target="_blank"
