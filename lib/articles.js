/* ============================================================
   autoelectrico.uy — Lista de artículos publicados

   Fuente única: NewsFeed.jsx (portada) y /noticias (listado
   completo) importan de acá. Agregar un artículo nuevo es una
   entrada aquí, no en cada lugar donde se muestre.
...
export const ARTICLES = [
  {
    slug: 'toyota-rav4-phev-uruguay',
    category: 'Análisis · Lanzamiento local',
    title: 'Toyota RAV4 PHEV: U$S 84.990 por 142 km eléctricos',
    dek: 'Ayax trajo el primer híbrido enchufable de Toyota a Uruguay. No es un eléctrico, y el bZ4X de la propia marca cuesta 35.000 dólares menos con 525 km de autonomía.',
    date: '2026-08-01',
  },
  {
    slug: 'puerto-montevideo-saturado-electricos',
    category: 'Noticias · Uruguay',
    title: 'El puerto de Montevideo se saturó de autos eléctricos',
    dek: 'Hubo autos estacionados debajo de un viaducto por falta de lugar. La ANP acondiciona dos hectáreas ganadas al mar para 2.000 vehículos más — y la mayoría ni siquiera se quedan en Uruguay.',
    date: '2026-07-26',
  },
  {
